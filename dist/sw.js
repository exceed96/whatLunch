if (!self.define) {
  ...
  self.define = (s, r) => {
    ...
    i[c] = Promise.all(s.map((e) => t[e] || d(e))).then((e) => (r(...e), o));
  };
}
...
define(["./workbox-5ffe50d4"], function (e) {
  ...
  self.skipWaiting(),
    ...
    e.precacheAndRoute(
      [
        { url: "assets/index-Ccqp5iJP.js", revision: null },
        { url: "assets/index-PGvfsCAl.css", revision: null },
        { url: "index.html", revision: "422c3e6eeebb6dfb1bc08830995304d1" },
